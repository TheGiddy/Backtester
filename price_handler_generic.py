from price_handler_base import AbstractPriceHandler, AbstractBarPriceHandler
from price_handler_iterator_base import AbstractBarEventIterator
from exception import EmptyBarEvent, EmptyTickEvent


class AbstractGenericHandler(object):
